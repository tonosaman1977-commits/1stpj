...
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 1.1 | /api/auth/login | POST | [x] | [x] | [x] | - | [x] | [ ] |
| 1.2 | /api/auth/logout | POST | [x] | [x] | [x] | - | [x] | [ ] |
| 1.3 | /api/auth/me | GET | [x] | [x] | [x] | - | [x] | [ ] |

#### スライス2-A: テーマ管理

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 2A.1 | /api/themes | GET | [x] | [x] | [x] | - | [x] | [ ] |
| 2A.2 | /api/themes | POST | [x] | [x] | [x] | - | [x] | [ ] |
| 2A.3 | /api/themes/:id | PUT | [x] | [x] | [x] | - | [x] | [ ] |
| 2A.4 | /api/themes/:id | DELETE | [x] | [x] | [x] | - | [x] | [ ] |
| 2A.5 | /api/themes/:id/activate | POST | [x] | [x] | [x] | - | [x] | [ ] |

#### スライス2-B: スケジュール設定

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 2B.1 | /api/schedule | GET | [x] | [x] | [x] | - | [x] | [ ] |
| 2B.2 | /api/schedule | PUT | [x] | [x] | [x] | - | [x] | [ ] |

#### スライス3: 投稿履歴

| タスク | エンドポイント | メソッド | 実装 | Unit | 内部 | 外部 | 品質 | FE統合 |
|--------|--------------|---------|:----:|:----:|:----:|:----:|:----:|:------:|
| 3.1 | /api/history | GET | [x] | [x] | [x] | [x] | [x] | [ ] |
